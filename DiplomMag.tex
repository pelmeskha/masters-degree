...
\section{Введение}\label{ch120}
	В нелинейной оптике на сегодняшний день известно множество подходов к описанию процессов распространения импульсов в оптических средах, некоторые из которых основаны на обобщениях классического интегрируемого нелинейного уравнения Шрёдингера\cite{Rad04,Rad05}:
	...
	\begin{enumerate}
		...
		\item установление факта устойчивости построенного решения с помощью численного моделирования процессов распространения, 
		\item анализ влияния нелинейных членов высших степеней в математической модели. 
	\end{enumerate}
\newpage
